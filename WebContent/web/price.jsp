...
<link rel="stylesheet" href="<c:url value="/resources/web/css/price.css"/>" />
<div class="row">
  ...
  <div class="row-fluid" id="pricing">
    ...
    <div class="col-md-3">
      <div class="price-plan">
        <h2> Professional</h2>
        <div class="price">
          <div class="inside"> <span class="super">$</span><span class="amt">11</span> <span class="sub">/mo</span> </div>
        </div>
        <div class="info">
          <ul>
            <li class="feature-page-limit">Unlimited Active Goals</li>
            <li class="feature-bandwidth-limit">Unlimited Team Members</li>
            <li class="feature-storage-limit">Free Forecast & Budgets</li>
            <li class="feature-free-domain">Export Doc/PDF <span class="free">Free</span></li>
            <li class="feature-support">Secure SSL Connection</li>
          </ul>
